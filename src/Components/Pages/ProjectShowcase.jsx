...
const ProjectShowcase = () => {
  ...
  return (
    <div className="container mx-auto py-8 sm:py-12 px-4">
      ...
      <div className="relative overflow-hidden h-[400px] sm:h-[450px] md:h-[500px] lg:h-[550px]">
        {/* Laptop frame with lighting effect */}
        <div className="absolute inset-0 bg-transparent rounded-lg overflow-hidden">
          ...
          <div className="absolute inset-2 bg-gray-50  rounded-lg"></div>
        </div>
  ...
  className={`project-card ${project.position} relative bg-transparent rounded-2xl shadow-md overflow-hidden transition-all duration-500 w-64 sm:w-72 md:w-80 lg:w-96 flex-shrink-0 mx-2 sm:mx-4 cursor-pointer 
  ...
  style={{
    padding: '2px', // This ensures the 5px border
    backgroundClip: 'padding-box',
    transitionDelay: `${index * 150}ms`
  }}
  onClick={() => toggleExpand(project)}
>
  {/* Inner container with the actual card content */}
  <div className="bg-gray-100 rounded-2xl w-full h-full">
    <div className="relative flex items-center justify-center h-40 sm:h-48 md:h-56 lg:h-72 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center -top-[12%] z-20">
        <div className="lg:w-[87.9%] w-[77.9%] h-[62.3%] md:w-[82.3%] md:h-[60%]  lg:h-[61.1%] rounded-sm overflow-hidden" style={{ marginTop: '-3%' }}>
    ...
    <div className="p-5">
      ...
      <div className="flex justify-between items-center">
        ...
        {projects.length > 1 && (
          <>
            <button
              className="absolute left-6 sm:left-8 top-1/2 transform -translate-y-1/2 bg-purple-700 text-white p-1 sm:p-2 rounded-full hover:bg-purple-800 transition-colors duration-300 hover:scale-110 z-20"
              onClick={prevProject}
            >
              <FaChevronLeft size={16} className="sm:w-6 sm:h-6" />
            </button>
            <button
              className="absolute right-6 sm:right-8 top-1/2 transform -translate-y-1/2 bg-purple-700 text-white p-1 sm:p-2 rounded-full hover:bg-purple-800 transition-colors duration-300 hover:scale-110 z-20"
              onClick={nextProject}
            >
